...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个影视记录者🍚', // 作者简介
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/366155825?spm_id_from=333.1007.0.0', // B站主页
